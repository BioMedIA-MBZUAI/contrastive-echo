...
class CamusSimCLR(torchvision.datasets.VisionDataset):
    ...
    def __init__(self, root=None, split="train"):
        ...
        if split == "train":
            ...
            keys = list(self.images.keys())[0:300]
...
class CamusSimCLRDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        self.data_train = CamusSimCLR(root=self.data_dir, split="train")
        self.data_val = CamusSimCLR(root=self.data_dir, split="test")
