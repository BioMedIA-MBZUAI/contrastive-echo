...
class DeepLabV3Model(LightningModule):
    ...
    def __init__(
        ...
        if self.hparams.byol.model_path != None:
            print("-------BYOL LOADING: " + self.hparams.byol.model_path + "-------")
            ...
            model.backbone = torchvision.models._utils.IntermediateLayerGetter(pretext_model.online_network.encoder, {'layer4':'out'})
