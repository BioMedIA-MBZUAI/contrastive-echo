...
from src.models.simclru_model import SimCLR
...
class UNetModel(LightningModule):
    ...
    def __init__(
        ...
        simclr: dict = {"model_path": "", "num_samples": 0, "batch_size": 128, "temperature": 0.05},
        lr: float = 0.001,
        ...
        #    print("-------UNET SimCLR LOADING: " + self.hparams.simclr.model_path + "-------")
        #    pretext_model = SimCLR(1, num_samples = self.hparams.simclr.num_samples, batch_size = self.hparams.simclr.batch_size, dataset = 'cifar10', temperature=self.hparams.simclr.temperature)
        #    pretext_model.load_state_dict(torch.load(self.hparams.simclr.model_path)["state_dict"])
        #    backbone = torchvision.models._utils.IntermediateLayerGetter(pretext_model.encoder, {'down4':'down4'})
