...
class SimCLR(LightningModule):
    ...
    def init_model(self):
        if self.arch == "resnet18":
            ...
            backbone = resnet50
            # return models.resnet50(replace_stride_with_dilation=[False, True, True])

        return backbone(first_conv=self.first_conv, maxpool1=self.maxpool1, return_all_feature_maps=False, replace_stride_with_dilation=[False, True, True])
